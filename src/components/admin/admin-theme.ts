...
export const adminEyebrowClass =
  "mb-1 text-xs font-bold uppercase tracking-[0.25em] text-gold-400/90";

export const adminTitleClass = "text-2xl font-light text-white md:text-3xl";

export const adminSubtitleClass = "mt-1 max-w-2xl text-sm text-white/55";

export const adminCardClass =
  "rounded-2xl border border-gold-500/10 bg-brand-navy-900/50 p-4 shadow-lg shadow-black/20 backdrop-blur-md md:p-5";

export const adminSubCardClass =
  "rounded-xl border border-gold-500/10 bg-brand-navy-950/35 p-4";

export const adminInputClass =
  "min-h-11 border-white/10 bg-white/5 text-white shadow-none placeholder:text-white/30 focus-visible:border-gold-400/45 focus-visible:ring-gold-400/20";

export const adminNativeSelectClass = cn(
  "min-h-11 w-full rounded-xl border border-white/10 bg-white/5 px-3 text-sm text-white",
...
export const adminTextareaClass = cn(
  "w-full rounded-xl border border-white/10 bg-white/5 px-3 py-3 text-sm text-white outline-none placeholder:text-white/30",
  "focus-visible:border-gold-400/50 focus-visible:ring-2 focus-visible:ring-gold-400/20",
);

export const adminFieldLabelClass =
  "mb-1.5 block text-xs font-medium uppercase tracking-wider text-white/45";
...
export const adminSearchIconClass =
  "pointer-events-none absolute left-3 top-1/2 size-4 -translate-y-1/2 text-gold-500/60";

export const adminEmptyStateClass =
  "rounded-xl border border-dashed border-gold-500/20 bg-brand-navy-950/25 px-6 py-16 text-center text-white/55";
...
export const adminModalClass =
  "flex max-h-[92vh] w-full flex-col overflow-hidden rounded-t-3xl border border-gold-500/15 bg-brand-navy-900 shadow-2xl backdrop-blur-md sm:rounded-3xl";
...
export const adminIconButtonClass =
  "inline-flex size-9 cursor-pointer items-center justify-center rounded-full text-white/70 transition-colors hover:bg-white/10 hover:text-gold-300";
...
export const adminHintClass = "mt-1 text-xs text-white/40";
...
export function adminFilterPillClass(active: boolean) {
  return cn(
    ...
    active
      ...
      : "border border-white/10 bg-white/5 text-white/70 hover:border-gold-400/30 hover:text-gold-300",
  );
}
